#(URI 1847) O inverno é uma estação maravilhosa, não é mesmo? 
# Todos nós amamos vestir um poncho, participar de uma roda de chimarrão, 
# assar pinhões no fogão a lenha… Mas nem todos gostam do inverno,
# especialmente em lugares onde o inverno costuma ser muito cruel. 
# Em Westeros, por exemplo, o humor das pessoas é definido de acordo com 
# as tendências climáticas. Com base nas temperaturas dos três últimos 
# dias, as pessoas podem ficar tristes ou felizes, ficando mais propensas
# a fazer guerra ou fazer amor, respectivamente. E, sejamos sinceros,
# é justamente por causa das cenas de amor e de guerra que amamos 
# Game of Thrones!
...
#Faça a função humor() que recebe 3 parâmetros, representando as respectivas temperaturas registradas no 1º, 2º e 3º dia. 
#A função deve retornar uma string de carinha feliz ou triste, de acordo com o humor do povo de Westeros.
